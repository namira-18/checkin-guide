...
const CheckInGuide = () => {
    ...
    return (
        <div className="bg-gradient-to-br from-blue-50 to-white min-h-screen py-8 px-4">
            <div className="max-w-xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
                ...
                <div className="bg-blue-600 text-white text-center py-6 px-4">
                    <h1 className="text-3xl font-bold mb-2">Panduan Check-In</h1>
                    <h2 className="text-xl font-semibold">{property}</h2>
                    {guestName && (
                        <p className="text-lg mt-2">Hai {guestName}, Selamat Datang! 🏡</p>
                    )}
                </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {checkIn && (
                            <div>
                                ...
                                <p className="text-gray-700">{checkIn}</p>
                            </div>
                        )}
                        {checkOut && (
                            <div>
                ...
                <div className="p-6 border-b">
                    <h3 className="text-xl font-semibold text-blue-800 mb-4">Waktu Check-In & Check-Out</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                ...
                {/* Facilities */}
                <div className="p-6 border-b">
                    <h3 className="text-xl font-semibold text-blue-800 mb-4">📡 Fasilitas Guesthouse</h3>
                ...
                {/* House Rules */}
                <div className="p-6 border-b">
                    <h3 className="text-xl font-semibold text-blue-800 mb-4">📜 Aturan Guesthouse</h3>
                    <ul className="space-y-3">
                        <li className="flex items-center">
                ...
                <div className="p-6 bg-blue-50 text-center">
                    <h3 className="text-xl font-semibold text-blue-800 mb-4">📞 Butuh Bantuan?</h3>
                    <p className="mb-4">Hubungi kami melalui WhatsApp:</p>
                    <p className="text-2xl font-bold text-green-600">+6281357009680</p>
